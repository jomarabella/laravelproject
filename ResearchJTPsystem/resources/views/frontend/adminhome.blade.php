        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" style="background: black;">
            ...
            <img src="assets/img/jtp-logo.jpg" style="width:100px; padding-right: 10px;" alt="" /> 
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item"><a class="nav-link" href="{{url('adminapp')}}">Appointment</a></li>
                    @if(!Session::has('adminId'))
                            <li class="nav-item"><a class="nav-link" href="{{url('loginAdmin')}}">Login</a></li>
         ...
         <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">JTP Studio where we capture your Smile.</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/services/wedding.jpg" alt="..." /></div><br>
                        </span>
                        <h4 class="my-3">Wedding Photoshot Package</h4>
                        <p class="text-muted">Giving You The Best Quality Photoshoot Of Your Dream Wedding.  </p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/services/grad3.jpg" alt="..." /></div><br>
                        </span>
                        <h4 class="my-3">Graduation Picturial</h4>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                        <div class="timeline-image"><img class="rounded-circle img-fluid" src="assets/img/services/chris1.jpg" alt="..." /></div><br>
                        </span>
                        <h4 class="my-3">Christening Photoshoot</h4>
                        <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima maxime quam architecto quo inventore harum ex magni, dicta impedit.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">See The Amazing Works of JTP Studio.</h3>
                </div>
                <div class="row">
        ...
        <section class="page-section" id="about">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">JTP .</h3>
                </div>
                <ul class="timeline">
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 text-lg-start">Distributed By <a href="https://themewagon.com/">CLIENT JOHN SENO</a></div>
